...
def configure(in_cloud_shell: bool,
    ...
    composer_size = config.get("composer_size","")
    config["composer_size"] = composer_size
    ...
    composer_size = get_value(
            session,
            "Composer Environment Size",
            default_value=composer_size.lower(),
            description="Specify Environment Size small/medium/large.",
        )
    composer_size = composer_size.lower() 
    config["composer_size"] = composer_size
